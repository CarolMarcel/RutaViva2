...
import { X, Calendar, Users, MessageSquare, CreditCard } from 'lucide-react';
...
export function ReservationForm({ destination, onClose, onSuccess }: ReservationFormProps) {
  ...
  const totalAmount = destination.price_per_person * formData.numberOfPeople;
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!validateNumber(formData.numberOfPeople, 1, destination.max_capacity)) {
      setError(`El número de personas debe estar entre 1 y ${destination.max_capacity}`);
      return;
    }
      ...
      <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">
                Número de Personas (Máx. {destination.max_capacity})
              </label>
              <div className="relative">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, numberOfPeople: parseInt(e.target.value) || 1 })
                  }
                  min="1"
            ...
            <div className="bg-gray-50 rounded-lg p-4 space-y-2">
              <div className="flex justify-between text-sm">
                ...
                <span className="font-medium">{formatCurrency(destination.price_per_person)}</span>
              </div>
              <div className="flex justify-between text-sm">
